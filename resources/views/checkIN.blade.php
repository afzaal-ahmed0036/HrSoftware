        ...
        <div class="col-6 offset-3">
            <div class="card">
                <div class="card-header" align="center">
                    <h3 class="text-info">Please Select Your CheckIn TIme</h3>
                    <a href="{{ url('notCheckedIn') }}" class="btn btn-danger">Logout</a>
                </div>
                    ...
                    <div class="row">
                        <div class="col-4 offset-4">
                            <form action="{{ url('saveCheckIN') }}" method="POST">
                                @csrf
                                <label class="mb-2" for=""><strong>Choose CheckIn Time</strong></label>
