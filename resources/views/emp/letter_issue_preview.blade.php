                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <input class="form-control" type="hidden" name="EmployeeID"
                                                id="example-email-input" required value="{{ session::get('EmployeeID') }}">

                                            <input class="form-control" type="hidden" name="LetterID"
                                                id="example-email-input" required value="{{ $letter[0]->LetterID }}">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" name="Title"
                                                        id="example-email-input" required value="{{ $letter[0]->Title }}">
                                                </div>
                                            </div>
