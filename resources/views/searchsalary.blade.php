                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right ">
                                        <div class="page-title-right text-danger">
                                         ...
                                         <a href="{{ URL('/SalaryExport/' . session::get('MonthName') . '/' . session::get('BranchID')) }}"
                                        target="_blank" class="shadow-sm btn btn-primary btn-rounded w-sm"><i
                                            class=""></i>Export</a>
                                        ...
                                        <table   class="table table-sm table-bordered dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable_info" style="width: 1247px;">
                                            ...
                                            <tr>
                                                ...
                                                <td> {{$value->EmployeeName}} </td>
                                                 ...
                                                 <td class="d-print-none"> <a href="{{URL('/SalaryEdit/'.$value->SalaryID)}}"  ><i class="bx bx-pencil align-middle me-1"></i></a> <a href="#" onclick="delete_confirm2('SalaryDelete',{{$value->SalaryID}})"><i class="bx bx-trash  align-middle me-1"></i></a></td>
